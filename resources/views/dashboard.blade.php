    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-8">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <a href="{{ route('shared.index') }}" class="group flex flex-col items-center p-6 rounded-xl border-2 border-teal-100 hover:border-teal-500 transition-all hover:shadow-lg bg-white">
                    <div class="bg-teal-50 group-hover:bg-teal-100 rounded-full p-4 mb-3 transition-colors">
                        <svg class="w-8 h-8 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                    </div>
                    <span class="text-sm font-semibold text-gray-900 group-hover:text-teal-600">Shared Photos</span>
                    <span class="text-xs text-gray-500 mt-1 text-center">See team's albums</span>
                </a>
            </div>
        </div>
    </div>
